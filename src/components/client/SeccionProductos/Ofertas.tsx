...
export default function Ofertas() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-8 left-4 z-20 rotate-[-6deg] bg-red-600 text-white px-2 md:px-5 py-2 rounded-lg text-xs md:text-lg font-bold shadow-lg border-2 md:border-3 border-white drop-shadow-[0_0_8px_rgba(255,0,0,0.8)]">
        ¡ OFERTAS !
      </div>
          ...
          >
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/90 via-black/70 to-transparent p-6 z-10">
                <div className="inline-flex flex-col md:flex-row md:items-center gap-1 md:gap-3 bg-gradient-to-r from-orange-600 to-red-500/90 rounded-xl px-2 md:px-4 py-1 md:py-2 shadow-xl border border-white/20">
                  {producto.price_oferta && (
                    <div className="flex flex-col text-white">
                      ...
                      <span className="text-lg md:text-2xl font-extrabold drop-shadow-md">
                        {formatCLP(producto.price_oferta)}
                      </span>
                    </div>
                  )}

                  {producto.price && (
                    <div className="flex flex-col md:ml-4 text-orange-100">
                      <span className="text-[8px] md:text-xs font-medium uppercase tracking-wide opacity-80">
                        Precio Antes
                      </span>
                      <span className="text-sm md:text-xl font-bold line-through opacity-90">
                ...
                <h3 className="text-md md:text-3xl font-bold mt-4 text-white drop-shadow-lg">
                  {producto.name}
                </h3>
              </div>

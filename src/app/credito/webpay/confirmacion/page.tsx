...
export default function WebpayConfirmacion() {
    ...
    const handleEnviarComprobante = async () => {
        ...
        try {
            ...
            const res = await fetch("/api/creditos/pagos/webpay/enviar-comprobante-cliente", {
                method: "POST",
                    ...
                    <div className="max-w-lg w-full bg-white shadow-lg rounded-2xl p-6 border border-gray-200">
                        ...
                        <div className="bg-gray-50 rounded-xl p-4 border border-gray-200 mb-6">
                            ...
                            <div className="space-y-2 text-gray-700">
                                <p><span className="font-semibold">Numero del credito:</span> {data.credito.data.numero_credito}</p>
                                <p><span className="font-semibold">Estado:</span> {data.credito.data.estado}</p>
                                <p><span className="font-semibold">Monto total del credito:</span> ${data.credito.data.monto.toLocaleString("es-CL")}</p>
                                <p><span className="font-semibold">Saldo pendiente del credito:</span> ${data.credito.data.saldo_pendiente.toLocaleString("es-CL")}</p>
                            </div>
                        ...
                        <div className="bg-gray-50 rounded-xl p-4 border border-gray-200 mb-6">
                            ...
                            <div className="space-y-2 text-gray-700">
                                <p><span className="font-semibold">Numero Orden:</span> {data.webpay.buy_order}</p>
